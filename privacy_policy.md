...
**b) Usuarios finales (estudiantes, residentes, miembros):** Sus datos personales son tratados bajo la responsabilidad de la organización a la que pertenecen. SOCIALO procesa estos datos siguiendo las instrucciones de dicha organización.
...
En caso de que se detecte de forma accidental el tratamiento de estas categorías de datos, se procederá a su supresión inmediata y se notificará al responsable del tratamiento para que adopte las medidas correctoras oportunas.
...
- **Ejecución de un contrato** para el registro, acceso y uso de la aplicación.
...
- **Interés legítimo** para análisis y mejora del servicio.
...
Conforme al artículo 32 de la LOPDGDD, los datos personales podrán conservarse **debidamente bloqueados** durante un período máximo de **5 años** desde la finalización de la relación, exclusivamente para atender posibles responsabilidades legales derivadas del tratamiento (fiscales, civiles, mercantiles o administrativas), en cumplimiento del artículo 1.964.2 del Código Civil español.
...
En algunos casos, solo cuando sea necesario, se proporcionarán datos de los usuarios a terceros. **Sin embargo, los datos nunca se venderán a terceros.**
...
SOCIALO mantiene actualizada una lista de todos los proveedores que realizan transferencias internacionales, especificando los países de destino y los mecanismos de protección aplicados. Esta información está disponible previa solicitud.
...
- A través de dpo@socialo.live, quien trasladará tu solicitud al responsable correspondiente de forma inmediata y, en cualquier caso, en el plazo máximo de un día laborable.
